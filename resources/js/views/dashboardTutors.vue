<template>
  <div class="flex h-screen flex-col">
    <header class="flex items-center justify-between bg-gradient-to-br from-cyan-700 to-emerald-500 text-white px-4 sm:px-6 py-3">
    ...
    <div class="flex flex-1 overflow-hidden">
      <aside class="w-64 border-r bg-cyan-50/40 px-4 sm:px-8 py-6 flex flex-col hidden sm:flex">
        <div class="flex flex-col items-center mb-6 ">
          ...
          <h2 class="text-lg font-semibold">Jelli C. Uayan</h2>
      ...
      <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6">
          <template v-if="currentSection === 'dashboard'">
            <h2 class="mb-6 text-xl sm:text-2xl font-bold">Welcome Back, Jelli!</h2>
            <div class="space-y-4">
                  ...
                  <div class="space-y-4">
                    <div v-for="session in upcomingSessions" :key="session.id" class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div class="mb-2 sm:mb-0">
                        <p class="font-medium">{{ session.student }}</p>
                  ...
                  <div class="space-y-4">
                    <div v-for="session in pastSessions" :key="session.id" class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        ...
                        <p class="text-sm text-gray-500">Student: {{ session.student }}</p>
              ...
              <div v-if="currentTab === 'My Students'" class="space-y-4">
                <div class="bg-white shadow rounded-lg p-4 sm:p-6">
                  <h3 class="text-lg font-semibold mb-4">My Students</h3>
                  <div class="space-y-4">
                    <div v-for="student in MyStudent" :key="student.id" class="flex items-center space-x-4">
            ...
            <div class="h-full flex flex-col bg-white shadow-xl">
              <div class="flex-1 h-0 overflow-y-auto">
                ...
                <div class="flex flex-col items-center p-6">
                  ...
                  <h2 class="mt-4 text-xl font-semibold">Jelli C. Uayan</h2>
                  <p class="text-sm text-gray-500">Tutor</p>
                </div>
                <nav class="mt-6 px-6">
                  <ul class="space-y-2">
...
const jelatImage = '/img/jelat.jpg';
...
const upcomingSessions = [
  { id: 1, student: 'Jeon Wonwoo', subject: 'Chemistry', time: '2:00pm' },
  { id: 2, student: 'Kim Mingyu', subject: 'Calculus 1', time: '3:30pm' },
]

const pastSessions = [
  { id: 1, subject: 'Physics 1', student: 'Kim Taehyung', date: '2024-10-10' },
  { id: 2, subject: 'Algebra 2', student: 'Juan Dela Cruz', date: '2024-10-08' },
]

const MyStudent = [
  { id: 1, name: 'Kim Taehyung', subjects: ['Chemistry', 'Physics'], avatar: '' },
  { id: 2, name: 'Juan Dela Cruz', subjects: ['Calculus', 'Algebra'], avatar: '' },
]
...
const emails = ref([
  { id: 1, sender: 'Jane Smith', receiver: 'jelli@example.com', message: 'Hello, how are you?' },
  { id: 2, sender: 'Bob Johnson', receiver: 'jelli@example.com', message: 'Meeting at 3 PM' },
])
