<template>
  <div class="space-y-4">
    ...
    <div v-if="currentTab === 'My Student'" class="space-y-4">
      <div class="bg-white shadow rounded-lg p-4 sm:p-6">
        <h3 class="text-lg font-semibold mb-4">Previous Students</h3>
        <div class="space-y-4">
          <div v-for="student in favoriteStudents" :key="student.id" class="flex items-center space-x-4">
...
const upcomingSessions = [
  { id: 1, student: "John Doe", subject: "Chemistry", time: "2:00 PM", location: "Online", type: "Video Call" },
  { id: 2, student: "Bernie Cherry Rante", subject: "Calculus 1", time: "3:30 PM", location: "Library", type: "In-person" },
];

const pastSessions = [
  { id: 1, subject: "Physics 1", student: "Alice", date: "2024-10-10" },
  { id: 2, subject: "Algebra 2", student: "Juan Dela Cruz", date: "2024-10-08" },
];

const favoriteStudents = [
  { id: 1, name: "John Doe", subjects: ["Chemistry", "Physics"], avatar: "/placeholder.svg?height=40&width=40" },
  { id: 2, name: "Bernie Cherry Rante", subjects: ["Calculus", "Algebra"], avatar: "/placeholder.svg?height=40&width=40" },
];
